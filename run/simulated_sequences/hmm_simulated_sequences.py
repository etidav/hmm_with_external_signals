...
if __name__ == "__main__":
    ...
    hmm_final_param = np.array([0., 1., -1, 2., 1., 0.25, -0.8, -1.4]).reshape((1,nb_param))
    ...
    shmm_final_param = np.array([0., 1., -1, 0.,0., 2., 0.,0., 1., 0.25, -0.8, 0.,0., -1.4, 0.,0.]).reshape((1,nb_param))
    ...
    hmmes_final_param = np.array([0., 1., -1, 0., 2., 0., 1., 0.25, -0.8, 0., -1.4, 0.]).reshape((1,nb_param))
    ...
    shmmes_final_param = np.array([0., 1., -1, 0., 0., 0., 2., 0., 0., 0., 1., 0.25, -0.8, 0., 0., 0.,-1.4,0.,0.,0.]).reshape((1,nb_param))
    ...
    hmm_true_parameter = np.array([0., 1., -1, 0., 0., 0., 2., 0., 0., 0., 1., 0.25, -0.8, 0., 0., 0.,-1.4,0.,0.,0.])
